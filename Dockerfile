...
LABEL org.opencontainers.image.title="semrel-plugin-provider-gitea" \
      org.opencontainers.image.description="semrel plugin: provider-gitea" \
      org.opencontainers.image.url="https://semrel.io" \
      org.opencontainers.image.source="https://github.com/SemRels/provider-gitea" \
